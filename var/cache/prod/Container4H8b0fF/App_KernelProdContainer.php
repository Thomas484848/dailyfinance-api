...
class App_KernelProdContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\UserMeController' => 'getUserMeControllerService',
            'App\\Controller\\WatchlistController' => 'getWatchlistControllerService',
            'App\\Controller\\WatchlistItemController' => 'getWatchlistItemControllerService',
    ...
    {
        return $container->services['api_platform.cache.metadata.property'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('VE4Xky4-O7', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    {
        return $container->services['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('fngj6imuzw', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    {
        return $container->services['api_platform.cache.metadata.resource_collection'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('WSKoUkmJmn', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    {
        return $container->services['cache.security_is_csrf_token_valid_attribute_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('qEYkUxHYOz', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('V033F2gDbn', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\AccountController', 'App\\Controller\\PasswordResetController', 'App\\Controller\\RegistrationController', 'App\\Controller\\SecurityController', 'App\\Controller\\StockController', 'App\\Controller\\UserMeController', 'App\\Controller\\WatchlistController', 'App\\Controller\\WatchlistItemController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    {
        return $container->privates['cache.property_access'] = \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('er6Pqa4Y7K', 0, $container->getParameter('container.build_id'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    {
        return $container->privates['cache.property_info'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('oRnYGZYiBu', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    {
        return $container->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('zM59TNOOlW', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    {
        return $container->privates['cache.serializer'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('QgnDQkYIwt', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    {
        return $container->privates['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('rfZlIJ5SBF', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    {
        $container->privates['doctrine.result_cache_pool'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('2-aQP8GU81', 0, (\dirname(__DIR__, 3).''.\DIRECTORY_SEPARATOR.'share'.\DIRECTORY_SEPARATOR.'prod/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, false)));
    ...
    {
        return $container->privates['doctrine.system_cache_pool'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('kjdyv7OJoP', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    protected static function getSerializerService($container)
    {
        ...
        $h = ($container->privates['property_info.cache'] ?? self::getPropertyInfo_CacheService($container));
        ...
        $p = new \ApiPlatform\JsonLd\Serializer\ItemNormalizer($a, $l, $b, $c, $m, $d, $g, $k, $n, $container->parameters['api_platform.serializer.default_context'], $o, NULL);

        $q = new \ApiPlatform\JsonLd\Serializer\ErrorNormalizer($p, $container->parameters['api_platform.serializer.default_context']);
        $r = new \ApiPlatform\Serializer\ItemNormalizer($l, $b, $c, $m, $g, $k, $n, NULL, $a, $o, [], NULL);
        ...
        $t = new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($n, $s, $g, $h, new \Symfony\Component\Serializer\Mapping\ClassDiscriminatorFromClassMetadata($n), NULL, $container->parameters['api_platform.serializer.default_context'], $h);
        ...
        $instance = new \Symfony\Component\Serializer\Serializer([new \Symfony\Component\Serializer\Normalizer\UnwrappingDenormalizer($g), $j, $j, new \ApiPlatform\Serializer\ConstraintViolationListNormalizer([], $k), new \ApiPlatform\Hydra\Serializer\ConstraintViolationListNormalizer([], $k, $container->parameters['api_platform.serializer.default_context']), $j, new \ApiPlatform\Symfony\Validator\Serializer\ValidationExceptionNormalizer($q, $k), new \App\Hydra\DocumentationNormalizerDecorator(new \ApiPlatform\Hydra\Serializer\DocumentationNormalizer($a, $l, $b, $m, $e, $k, $container->parameters['api_platform.serializer.default_context'], true), $f), new \App\Hydra\EntrypointNormalizerDecorator(new \ApiPlatform\Hydra\Serializer\EntrypointNormalizer($a, $c, $e), $f), new \ApiPlatform\Symfony\Validator\Serializer\ValidationExceptionNormalizer($r, $k), $q, new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(false, $container->parameters['api_platform.serializer.default_context'], NULL), new \Symfony\Component\Serializer\Normalizer\UidNormalizer($container->parameters['api_platform.serializer.default_context']), $p, $r, new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer($container->parameters['api_platform.serializer.default_context']), new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer($container->parameters['api_platform.serializer.default_context'], $s), new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer($container->parameters['api_platform.serializer.default_context']), new \Symfony\Component\Serializer\Normalizer\FormErrorNormalizer(), new \Symfony\Component\Serializer\Normalizer\BackedEnumNormalizer(), new \Symfony\Component\Serializer\Normalizer\NumberNormalizer(), new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(NULL), new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(NULL, NULL, $container->parameters['api_platform.serializer.default_context']), new \ApiPlatform\Hydra\Serializer\CollectionFiltersNormalizer(new \ApiPlatform\Hydra\Serializer\PartialCollectionViewNormalizer(new \ApiPlatform\Hydra\Serializer\CollectionNormalizer($d, $m, $c, $container->parameters['api_platform.serializer.default_context']), 'page', 'pagination', $a, $g, 1, $container->parameters['api_platform.serializer.default_context']), $a, $m, ($container->privates['api_platform.filter_locator'] ??= new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [], [])), $container->parameters['api_platform.serializer.default_context']), new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), new \ApiPlatform\JsonLd\Serializer\ObjectNormalizer($t, $c, $d), $t], [new \Symfony\Component\Serializer\Encoder\XmlEncoder($container->parameters['api_platform.serializer.default_context']), $i, $u, new \Symfony\Component\Serializer\Encoder\CsvEncoder($container->parameters['api_platform.serializer.default_context']), new \ApiPlatform\Serializer\JsonEncoder('jsonopenapi', NULL), new \ApiPlatform\Serializer\YamlEncoder('yamlopenapi', $u), new \ApiPlatform\Serializer\JsonEncoder('jsonld', NULL), new \ApiPlatform\Serializer\JsonEncoder('jsonproblem')], $container->parameters['api_platform.serializer.default_context']);
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'api_platform.swagger_ui.extra_configuration' => [
                'url' => '/api/docs.jsonopenapi',
                'spec' => NULL,
                'persistAuthorization' => true,
                'requestInterceptor' => 'function (req) { if (req.url && req.url.endsWith(\'/api/login\')) { req.body = JSON.stringify({"email":"duarte.thomas33@gmail.com","password":"Fermetagrandegueule0285$"}); } var token = null; try { token = window.localStorage.getItem(\'jwt_token\'); } catch (e) {} if (!token && window.__jwtToken) { token = window.__jwtToken; } if (token && req.url && !req.url.endsWith(\'/api/login\')) { req.headers = req.headers || {}; req.headers[\'Authorization\'] = \'Bearer \' + token; } return req; }',
                'responseInterceptor' => 'async function (res) { if (res.url && res.url.indexOf(\'/api/login\') !== -1) { try { var data = res.data; if (!data && res.body) { if (typeof res.body === \'string\') { try { data = JSON.parse(res.body); } catch (e) { data = null; } } else if (typeof res.body === \'object\') { data = res.body; } } if (!data && typeof res.json === \'function\') { data = await res.json(); res.data = data; } if (!data && typeof res.text === \'function\') { var text = await res.text(); try { data = JSON.parse(text); } catch (e) {} res.body = text; res.text = function () { return Promise.resolve(text); }; res.data = data; } var token = data && (data.token || data.access_token || data.jwt); if (!token && res.headers) { var headerAuth = res.headers[\'authorization\'] || res.headers[\'Authorization\']; if (headerAuth && headerAuth.startsWith(\'Bearer \')) { token = headerAuth.slice(7); } } if (token) { window.__jwtToken = token; try { window.localStorage.setItem(\'jwt_token\', token); } catch (e) {} if (window.__setJwtToken) { window.__setJwtToken(token); } if (window.__refreshSpec) { window.__refreshSpec(); } else { try { setTimeout(function () { window.location.reload(); }, 50); } catch (e) {} } } } catch (e) {} } return res; }',
                'onComplete' => 'function () { try { window.__setJwtToken = function (token) { try { if (token) { window.__jwtToken = token; try { if (!window.localStorage.getItem(\'jwt_token\')) { window.localStorage.setItem(\'jwt_token\', token); } } catch (e) {} if (window.ui && window.ui.getSystem) { var auth = window.ui.getSystem().authActions; if (auth && auth.authorize) { auth.authorize({ JWT: { name: \'JWT\', schema: { type: \'http\', scheme: \'bearer\', bearerFormat: \'JWT\' }, value: \'Bearer \' + token }, bearerAuth: { name: \'bearerAuth\', schema: { type: \'http\', scheme: \'bearer\', bearerFormat: \'JWT\' }, value: \'Bearer \' + token } }); } } } } catch (e) {} }; var token = null; try { token = window.localStorage.getItem(\'jwt_token\'); } catch (e) {} if (token) { window.__setJwtToken(token); } } catch (e) {} }',
            ],
