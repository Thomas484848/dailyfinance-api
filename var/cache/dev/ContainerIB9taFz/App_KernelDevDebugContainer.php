...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\StockHistoryController' => 'getStockHistoryControllerService',
        ...
        $this->privates['service_container'] = static function ($container) {
            ...
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Hydra'.\DIRECTORY_SEPARATOR.'DocumentationNormalizerDecorator.php';
            ...
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Hydra'.\DIRECTORY_SEPARATOR.'EntrypointNormalizerDecorator.php';
            ...
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'scheduler'.\DIRECTORY_SEPARATOR.'Messenger'.\DIRECTORY_SEPARATOR.'Serializer'.\DIRECTORY_SEPARATOR.'Normalizer'.\DIRECTORY_SEPARATOR.'SchedulerTriggerNormalizer.php';
    ...
    {
        return $container->services['api_platform.cache.metadata.property'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ld7IOYb7Jk', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    {
        return $container->services['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('VOcgdS66+2', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    {
        return $container->services['api_platform.cache.metadata.resource_collection'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('bK8K6uXLvh', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    {
        return $container->services['cache.security_is_csrf_token_valid_attribute_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('iivAN0VMwk', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('k9l1tPUiQN', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    {
        $instance = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'annotated_app_entity_stock_api_platform_doctrine_orm_filter_search_filter' => ['privates', 'annotated_app_entity_stock_api_platform_doctrine_orm_filter_search_filter', 'getAnnotatedAppEntityStockApiPlatformDoctrineOrmFilterSearchFilterService', true],
            'annotated_app_entity_stock_api_platform_doctrine_orm_filter_range_filter' => ['privates', 'annotated_app_entity_stock_api_platform_doctrine_orm_filter_range_filter', 'getAnnotatedAppEntityStockApiPlatformDoctrineOrmFilterRangeFilterService', true],
        ], [
            'annotated_app_entity_stock_api_platform_doctrine_orm_filter_search_filter' => '?',
            'annotated_app_entity_stock_api_platform_doctrine_orm_filter_range_filter' => '?',
        ]);
    ...
    {
        return $container->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('gJLDr+WqZf', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    protected static function getSerializerService($container)
    {
        ...
        $h = ($container->privates['api_platform.filter_locator'] ?? self::getApiPlatform_FilterLocatorService($container));

        if (isset($container->privates['serializer'])) {
            return $container->privates['serializer'];
        }
        $i = ($container->privates['property_accessor'] ?? self::getPropertyAccessorService($container));
        $j = ($container->privates['property_info'] ?? self::getPropertyInfoService($container));
        ...
        $n = ($container->privates['api_platform.metadata.property.name_collection_factory.cached'] ?? self::getApiPlatform_Metadata_Property_NameCollectionFactory_CachedService($container));
        ...
        $q = new \ApiPlatform\JsonLd\Serializer\ItemNormalizer($a, $n, $b, $c, $o, $d, $i, $m, $p, $container->parameters['api_platform.serializer.default_context'], $e, NULL);

        $r = new \ApiPlatform\JsonLd\Serializer\ErrorNormalizer($q, $container->parameters['api_platform.serializer.default_context']);
        $s = new \ApiPlatform\Serializer\ItemNormalizer($n, $b, $c, $o, $i, $m, $p, NULL, $a, $e, [], NULL);
        ...
        $u = new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($p, $t, $i, $j, new \Symfony\Component\Serializer\Mapping\ClassDiscriminatorFromClassMetadata($p), NULL, $container->parameters['api_platform.serializer.default_context'], $j);
        ...
        $instance = new \Symfony\Component\Serializer\Serializer([new \Symfony\Component\Serializer\Normalizer\UnwrappingDenormalizer($i), $l, $l, new \ApiPlatform\Serializer\ConstraintViolationListNormalizer([], $m), new \ApiPlatform\Hydra\Serializer\ConstraintViolationListNormalizer([], $m, $container->parameters['api_platform.serializer.default_context']), $l, new \ApiPlatform\Symfony\Validator\Serializer\ValidationExceptionNormalizer($r, $m), new \App\Hydra\DocumentationNormalizerDecorator(new \ApiPlatform\Hydra\Serializer\DocumentationNormalizer($a, $n, $b, $o, $f, $m, $container->parameters['api_platform.serializer.default_context'], true), $g), new \App\Hydra\EntrypointNormalizerDecorator(new \ApiPlatform\Hydra\Serializer\EntrypointNormalizer($a, $c, $f), $g), new \ApiPlatform\Symfony\Validator\Serializer\ValidationExceptionNormalizer($s, $m), new \Symfony\Component\Scheduler\Messenger\Serializer\Normalizer\SchedulerTriggerNormalizer(), new \Symfony\Component\Messenger\Transport\Serialization\Normalizer\FlattenExceptionNormalizer(), $r, new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(true, $container->parameters['api_platform.serializer.default_context'], NULL), new \Symfony\Component\Serializer\Normalizer\UidNormalizer($container->parameters['api_platform.serializer.default_context']), $q, $s, new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer($container->parameters['api_platform.serializer.default_context']), new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer($container->parameters['api_platform.serializer.default_context'], $t), new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer($container->parameters['api_platform.serializer.default_context']), new \Symfony\Component\Serializer\Normalizer\FormErrorNormalizer(), new \Symfony\Component\Serializer\Normalizer\BackedEnumNormalizer(), new \Symfony\Component\Serializer\Normalizer\NumberNormalizer(), new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(NULL), new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(NULL, NULL, $container->parameters['api_platform.serializer.default_context']), new \ApiPlatform\Hydra\Serializer\CollectionFiltersNormalizer(new \ApiPlatform\Hydra\Serializer\PartialCollectionViewNormalizer(new \ApiPlatform\Hydra\Serializer\CollectionNormalizer($d, $o, $c, $container->parameters['api_platform.serializer.default_context']), 'page', 'pagination', $a, $i, 1, $container->parameters['api_platform.serializer.default_context']), $a, $o, $h, $container->parameters['api_platform.serializer.default_context']), new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), new \ApiPlatform\JsonLd\Serializer\ObjectNormalizer($u, $c, $d), $u], [new \Symfony\Component\Serializer\Encoder\XmlEncoder($container->parameters['api_platform.serializer.default_context']), $k, $v, new \Symfony\Component\Serializer\Encoder\CsvEncoder($container->parameters['api_platform.serializer.default_context']), new \ApiPlatform\Serializer\JsonEncoder('jsonopenapi', NULL), new \ApiPlatform\Serializer\YamlEncoder('yamlopenapi', $v), new \ApiPlatform\Serializer\JsonEncoder('jsonld', NULL), new \ApiPlatform\Serializer\JsonEncoder('jsonproblem')], $container->parameters['api_platform.serializer.default_context']);
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'api_platform.collection.pagination.maximum_items_per_page' => 200,
