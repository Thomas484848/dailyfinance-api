...
class getApiPlatform_Openapi_CommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['api_platform.openapi.command'] = $instance = new \ApiPlatform\OpenApi\Command\OpenApiCommand(($container->privates['App\\OpenApi\\LoginRequestExampleOpenApiFactory'] ?? $container->load('getLoginRequestExampleOpenApiFactoryService')), ($container->privates['serializer'] ?? self::getSerializerService($container)));
