...
class getMessenger_Transport_SyncService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance = $a->createTransport('sync://', ['transport_name' => 'sync'], ($container->privates['messenger.transport.native_php_serializer'] ?? $container->load('getMessenger_Transport_NativePhpSerializerService')));
